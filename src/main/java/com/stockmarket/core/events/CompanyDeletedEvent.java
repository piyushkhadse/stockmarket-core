...
public class CompanyDeletedEvent extends DomainEvent{
    ...
    public CompanyDeletedEvent(String aggregateId, String aggregateType, String companyName, String companyCode,
                                  String companyCEO, Double companyTurnover, String companyWebsite, String stockExchange) {
        super(aggregateId, aggregateType, Events.COMPANY_DELETED_EVENT.getValue());
